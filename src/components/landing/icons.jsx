...
// Iconos para las tarjetas flotantes del Hero
export const FloatingCardIcons = {
  notas: (
...
// Iconos para las caracteristicas
...
// Icono de email para contacto y footer
export const EmailIcon = ({ size = 18, color = '#EA4335' }) => (
